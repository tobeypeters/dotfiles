...
#QEMU_FLAGS="-cpu host -smp 4 -m 4g -display gtk,zoom-to-fit=on -enable-kvm -rtc base=localtime #-audiodev alsa,id=snd0,out.dev=hw:0.0 -device sb16,audiodev=snd0
